...
def test_set_c_compiler(tmp_path, host_python, build_python):
    crossenv = make_crossenv(tmp_path, host_python, build_python, "--cc=/bin/true")
    compiler = crossenv.check_output(
        [
            "python",
            "-c",
            dedent(
...
def test_set_cxx_compiler(tmp_path, host_python, build_python):
    crossenv = make_crossenv(tmp_path, host_python, build_python, "--cxx=/bin/true")
    compiler = crossenv.check_output(
        [
            "python",
            "-c",
...
def test_set_ar(tmp_path, host_python, build_python):
    crossenv = make_crossenv(tmp_path, host_python, build_python, "--ar=/bin/true")
    compiler = crossenv.check_output(
        [
            "python",
            "-c",
...
def test_wrong_architecture(tmp_path, host_python, build_python, architecture):
    ...
    crossenv = make_crossenv(tmp_path, host_python, build_python, "--cc=/usr/bin/gcc")
